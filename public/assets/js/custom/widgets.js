            ...
            a = function () {
              ...
              var a = KTUtil.getCssVariableValue("--bs-gray-500"),
                ...
                l = {
                  ...
                  plotOptions: {
                    bar: { stacked: !0, horizontal: !1, borderRadius: 4, columnWidth: ["12%"] },
                  },
                  legend: { show: !1 },
                  dataLabels: { enabled: !1 },
        ...
        [].slice.call(t).map(function (t) {
          if (((e = parseInt(KTUtil.css(t, "height"))), t)) {
            ...
            new ApexCharts(t, {
              ...
              fill: {
                type: "gradient",
                gradient: { opacityFrom: 0.4, opacityTo: 0, stops: [20, 120, 120, 120] },
              },
      ...
      (function () {
        ...
        [].slice.call(t).map(function (t) {
          ...
          new ApexCharts(t, {
            ...
            colors: ["#ffffff"],
            plotOptions: {
              bar: { borderRadius: 2.5, dataLabels: { position: "top" }, columnWidth: "20%" },
            },
            dataLabels: {
              enabled: !1,
              formatter: function (e) {
