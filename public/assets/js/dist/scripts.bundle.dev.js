...
((KTDialer.getInstance = function (e) {
  ...
  (KTDialer.createInstances = function () {
    var e =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-kt-dialer="true"]';
...
((KTDrawer.getInstance = function (e) {
  ...
  (KTDrawer.hideAll = function () {
    ...
    var t =
      arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '[data-kt-drawer="true"]';
  ...
  (KTDrawer.updateAll = function () {
    var e =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-kt-drawer="true"]';
    var t = document.querySelectorAll(e);
    if (t && t.length > 0)
      for (var n = 0, i = t.length; n < i; n++) {
...
((KTImageInput.getInstance = function (e) {
  ...
  (KTImageInput.createInstances = function () {
    var e =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "[data-kt-image-input]";
    var t = document.querySelectorAll(e);
    if (t && t.length > 0)
      for (var n = 0, i = t.length; n < i; n++) {
...
((KTMenu.getInstance = function (e) {
      ...
      if (r && r.length > 0)
        for (var o = 0, a = r.length; o < a; o++) {
          if (((t = r[o]), (i = KTMenu.getInstance(t)) && "dropdown" === i.getItemSubType(t))) {
            if (
              (i.getElement(), (n = i.getItemSubElement(t)), t === e.target || t.contains(e.target))
            )
              continue;
  ...
  (KTMenu.createInstances = function () {
    var e =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-kt-menu="true"]';
    var t = document.querySelectorAll(e);
    if (t && t.length > 0)
      for (var n = 0, i = t.length; n < i; n++) {
        new KTMenu(t[n]);
...
((KTScroll.getInstance = function (e) {
  ...
  (KTScroll.createInstances = function () {
    var e =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-kt-scroll="true"]';
    var t = document.body.querySelectorAll(e);
    if (t && t.length > 0)
      for (var n = 0, i = t.length; n < i; n++) {
        new KTScroll(t[n]);
      ...
      var i = {
        ...
        a = function a(e) {
          ...
          if (
            ...
            null !== a &&
              (KTUtil.css(n.element, "z-index", a), KTUtil.css(n.element, "position", "fixed")),
...
((KTSticky.getInstance = function (e) {
  ...
  (KTSticky.createInstances = function () {
    var e =
      arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '[data-kt-sticky="true"]';
    var t = document.body.querySelectorAll(e);
    if (t && t.length > 0)
      for (var n = 0, i = t.length; n < i; n++) {
        new KTSticky(t[n]);
  ...
  return {
    ...
    outerWidth: function outerWidth(e, t) {
      ...
      return !0 === t
        ? ((n = parseFloat(e.offsetWidth)),
          (n +=
            parseFloat(KTUtil.css(e, "margin-left")) + parseFloat(KTUtil.css(e, "margin-right"))),
          parseFloat(n))
        : (n = parseFloat(e.offsetWidth));
    },
    ...
    colorLighten: function colorLighten(e, t) {
      ...
      return (
        ...
        "#"
          .concat(n(e.substring(0, 2), t))
          .concat(n(e.substring(2, 4), t))
          .concat(n(e.substring(4, 6), t))
      );
    },
    ...
    getResponsiveValue: function getResponsiveValue(e, t) {
      ...
      if ("object" == _typeof((e = KTUtil.parseJson(e)))) {
        ...
        for (var l in e) {
          (o = "default" === l ? 0 : this.getBreakpoint(l) ? this.getBreakpoint(l) : parseInt(l)) <=
            n &&
            o > a &&
            ((r = l), (a = o));
        }
  ...
  var e,
    ...
    i = function i(_i2, r) {
      ...
      (document.documentElement.setAttribute("data-kt-theme-mode-switching", "true"),
        document.documentElement.setAttribute("data-bs-theme", _i2),
        setTimeout(function () {
          document.documentElement.removeAttribute("data-kt-theme-mode-switching");
        }, 300),
        localStorage.setItem("data-bs-theme", _i2),
        s && (localStorage.setItem("data-bs-theme-mode", r), a(s)),
        _i2 !== l && KTEventHandler.trigger(document.documentElement, "kt.thememode.change", t));
    },
    r = function r() {
      if (!e) return null;
...
("undefined" != typeof module && void 0 !== module.exports && (module.exports = KTCustomWidgets),
  KTUtil.onDOMContentLoaded(function () {
