  ...
  return {
    init: function () {
      ...
      (n = document.querySelector("#kt_app_sidebar_toggle")),
        (e = document.querySelector("#kt_app_sidebar_wrapper")),
        (t = document.querySelector("#kt_app_sidebar")),
        n &&
          null !== (i = KTToggle.getInstance(n)) &&
          (i.on("kt.toggle.change", function () {
        ...
        e &&
          (r = e.querySelector(".menu-link.active")) &&
          !0 !== KTUtil.isVisibleInContainer(r, e) &&
          e.scroll({
